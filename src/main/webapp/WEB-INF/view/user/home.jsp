...
<body>
<nav class=" navbar-expand-lg navbar-light bg-light" style="background:#6600FF">
  <div class="p-3 mb-2 bg-warning text-dark collapse navbar-collapse shadow-sm p-3 mb-5 bg-white rounded" id="navbarSupportedContent" style="background:#8DB6CD">
	...
	<div class="container row">
		<div class="col-md-2" style="margin-top:20px ; border-right:solid 2px"> 
			...
			<ul class="nav flex-column mymenuselected ">
				  <li class="nav-item ">
				    <a class="nav-link active text-dark"  href="/" >首页</a>
				  </li>
				  <li class="nav-item ">
				    <a class="nav-link active text-dark"  href="#" onclick="showWork($(this),'/user/articles')" >我的文章</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link text-dark" href="#" onclick="showWork($(this),'/user/postArticle')">发表文章</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link text-dark" href="#" onclick="showWork($(this),'/user/listfavorite')">我的收藏夹</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link text-dark" href="#" onclick="showWork($(this),'/user/comments')" >我的评论</a>
				  </li>
				  <li class="nav-item">
