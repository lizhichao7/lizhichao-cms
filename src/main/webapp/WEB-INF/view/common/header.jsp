...
<nav class="navbar navbar-expand-lg navbar-dark " >
  <div class="collapse navbar-collapse shadow-sm p-3 mb-5 bg-white rounded" id="navbarSupportedContent" >
    ...
    <form class="form-inline my-2 my-lg-0" style="margin-right:30%" action="index" method="get">
      <input class="form-control mr-sm-2" name="key" value="${key}" type="search" placeholder="从es索引库来搜索" aria-label="搜索">
    ...
    <div>
    	<ul class="nav">
    		...
    		<li class="nav-item nav-link" style="color: #000000">${sessionScope.loing_session_key.username}</li>
